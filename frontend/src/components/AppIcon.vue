...
/** Material-style 24×24 path data, kept in one place so markup stays legible. */
const PATHS = {
  ...
  // person / people / crowd form a deliberate progression — one, two, many —
  // so the comfort picker can show how busy each level means, not just say it.
  person:
  ...
  sun: 'M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zM2 13h2c.55 0 1-.45 1-1s-.45-1-1-1H2c-.55 0-1 .45-1 1s.45 1 1 1zm18 0h2c.55 0 1-.45 1-1s-.45-1-1-1h-2c-.55 0-1 .45-1 1s.45 1 1 1zM11 2v2c0 .55.45 1 1 1s1-.45 1-1V2c0-.55-.45-1-1-1s-1 .45-1 1zm0 18v2c0 .55.45 1 1 1s1-.45 1-1v-2c0-.55-.45-1-1-1s-1 .45-1 1zM5.99 4.58a.996.996 0 10-1.41 1.41l1.06 1.06c.39.39 1.03.39 1.41 0s.39-1.03 0-1.41L5.99 4.58zm12.37 12.37a.996.996 0 10-1.41 1.41l1.06 1.06c.39.39 1.03.39 1.41 0a.996.996 0 000-1.41l-1.06-1.06zm1.06-10.96a.996.996 0 000-1.41.996.996 0 00-1.41 0l-1.06 1.06c-.39.39-.39 1.03 0 1.41s1.03.39 1.41 0l1.06-1.06zM7.05 18.36a.996.996 0 000-1.41.996.996 0 00-1.41 0l-1.06 1.06c-.39.39-.39 1.03 0 1.41s1.03.39 1.41 0l1.06-1.06z',
  nose: 'M9 2v6.5c0 1.2-.6 2.3-1.6 3L6 12.6c-1.3.9-2 2.4-2 4V19c0 1.7 1.3 3 3 3h7c1.7 0 3-1.3 3-3v-1h2c1.1 0 2-.9 2-2 0-.5-.2-1-.5-1.4L17 11V2h-2v9.5c0 .4.1.8.4 1.1l2.3 2.8H15c-1.1 0-2 .9-2 2v1.6c0 .6-.4 1-1 1H7c-.6 0-1-.4-1-1v-2.4c0-.9.4-1.8 1.2-2.4l1.4-1.1C10.1 12.1 11 10.4 11 8.5V2H9z',
  cloud:
  ...
  park: 'M17 12h2L12 2 5.5 12h2l-3.5 6h6v4h4v-4h6l-3.5-6z',
  place:
